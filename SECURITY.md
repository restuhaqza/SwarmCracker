...
- **Host OS hardening** — SwarmCracker assumes a properly secured Linux host. See [Security Guide](docs/user/guides/security.md).
...
See [docs/user/guides/security.md](docs/user/guides/security.md) for detailed hardening instructions including:
